...
public abstract class AgenteIA {
	 ...
	 * FalhaProcessamentoAgenteException, PromptInadequadoException,
	 * ErroComunicacaoIAException {
	 * 
	 * // Validação básica (Enunciado original) if (prompt == null ||
	 * prompt.isEmpty()) { throw new
	 * FalhaProcessamentoAgenteException("O prompt não pode estar vazio."); } if
	 * (prompt.length() > 100) { throw new
	 * FalhaProcessamentoAgenteException("Prompt muito longo para o modelo atual.");
	 * }
	 * 
	 * // Exercício 1: Filtro de Segurança verificarSeguranca(prompt);
	 * 
	 * // Exercício 2: Simulação de Timeout chamarModeloExterno();
	 * 
	 * System.out.println("🚀 Agente finalizou processamento com sucesso: " +
	 * prompt); }
	 */
